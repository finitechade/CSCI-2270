...
ArrayBag<ItemType>::ArrayBag(const ArrayBag& anotherBag)
{
	...
	ItemType* d = new ItemType[anotherBag.getCapacity()];
	copy(anotherBag.items,anotherBag.items+anotherBag.myCapacity, d);
...
{
	ItemType* d = new ItemType[newCapacity];
	copy(items,items+myCapacity, d);
	delete [] items;
	items = d;
...
vector<ItemType> ArrayBag<ItemType>::toVector() const
{
	...
	bagContents.assign(items, items+itemCount);
